...
class OperatorError:
  ...
  @generator
  def build(ports):
    # CHECK: Operator '+' is not supported on bitvectors. LHS operand should be cast .asSInt/.asUInt.
    ports.a + ports.b
...
class OperatorError2:
  ...
  @generator
  def build(ports):
    # CHECK: Operator '+' is not supported on bitvectors. RHS operand should be cast .asSInt/.asUInt.
    ports.b + ports.a
